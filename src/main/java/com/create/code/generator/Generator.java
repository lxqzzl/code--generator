...
public class Generator {
	...
	public static void baseCodeGenerate(List<String> fileNames, Map<String, String> dataModel, String basePath,
		...
		// 创建输出目录子目录
		File childFiles = new File(targetPath + "/" + basePath.substring(basePath.lastIndexOf("\\") + 1));
		// 如果子目录不存在
		...
		for (String fileName : fileNames) {
			...
			Writer out = new FileWriter(new File(targetPath + "/" + basePath.substring(basePath.lastIndexOf("\\") + 1)
